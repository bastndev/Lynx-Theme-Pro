...
| Tiện ích                                                                                                                                                                                                             | Tên/>                                                                  | Mô tả                                                                                                                                                                                                                   |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![My Skills](https://open-vsx.org/api/bastndev/my-skills/latest/file/icon.png)](https://open-vsx.org/extension/bastndev/my-skills) | [My Skills](https://github.com/bastndev/My-Skills) | Tạo, cài đặt và quản lý các hướng dẫn AI có thể tái sử dụng cho các dự án của bạn, để trợ lý viết mã của bạn đã biết phong cách, quy tắc và quy trình làm việc của bạn. |
